...
public class DecodeException extends Exception {
     ...
     * error, depending whether the application is using one of the streaming
     * methods or not.
     *
     * @param bb
     *            the byte buffer containing the (part of) the message that
     ...
     * why it failed to be, and the cause. The encoded string may represent the
     * whole message, or the part of the message most relevant to the decoding
     * error, depending whether the application is using one of the streaming
     * methods or not.
     *
     * @param encodedString
     *            the string representing the (part of) the message that could
     *            not be decoded.
     * @param message
     *            the reason for the failure.
     * @param cause
     ...
     * the part of the message most relevant to the decoding error, depending
     ...
     * depending whether the application is using one of the streaming methods
     * or not.
     *
     * @param encodedString
     *            the string representing the (part of) the message that could
     ...
     * message, that could not be decoded, or {@code null} if this exception
     * arose from a failure to decode a text message.
     *
    ...
    /**
     * Return the encoded string that is either the whole message, or the
     * partial message that could not be decoded, or {@code null} if this
     * exception arose from a failure to decode a binary message..
     *
